...
it gets a red ▲ next to its price and "▲ N% over market" underneath (hover
the ▲ for the amounts); the cell itself isn't recoloured, so the cheapest
listing's highlight still shows. The last row totals each
